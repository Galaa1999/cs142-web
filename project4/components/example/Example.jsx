...
class Example extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      mottoData:window.cs142models.exampleModel().mottoData,
      name1:"Galt",
      counter: 0,
      inputValue: '',
      buttonWasClicked: '',
  ...
  render() {
    return (
      <div className="container Example">
        ...
        {this.state.mottoData}{/* Your problem #1 motto displaying and updating widget goes here */}
        </div>
...
`<p>My name is "{this.state.name}".</p>`
        ...
        <p className="cs142-example-output">
          My name is &ldquo; {this.state.name1} &rdquo;.
        </p>
